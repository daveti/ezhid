/*
 *
 * $Id: usb_core.h,v 1.5 2004/02/15 01:16:05 arniml Exp $
 *
...
static data sof_delay;        /* apply_reset_values */
...
code Byte string_if_pad[] = {
   0x7e, 0x03,
   'S',0, 'N',0, 'E',0, 'S',0, ' ',0, 'P',0, 'a',0, 'd',0,
   ' ',0, 'H',0, 'I',0, 'D',0, ' ',0, 'D',0, 'r',0, 'i',0,
   'v',0, 'e',0, 'r',0, ',',0, ' ',0, 'F',0, 'i',0, 'r',0,
   'm',0, 'w',0, 'a',0, 'r',0, 'e',0, ' ',0, 'C',0, 'o',0,
   'p',0, 'y',0, 'r',0, 'i',0, 'g',0, 'h',0, 't',0, ' ',0,
   '(',0, 'c',0, ')',0, ' ',0, '2',0, '0',0, '0',0, '4',0,
   ' ',0, 'A',0, 'r',0, 'n',0, 'i',0, 'm',0, ' ',0, 'L',0,
   'a',0, 'e',0, 'u',0, 'g',0, 'e',0, 'r',0
};
