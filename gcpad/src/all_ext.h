/*
 *
 * $Id: all_ext.h,v 1.2 2004/02/15 01:12:53 arniml Exp $
 *
...
/* Pad buffers */
extern volatile data Byte pad1_buffer[4];
extern volatile data Byte pad2_buffer[4];
extern volatile data Byte pad3_buffer[4];
extern volatile data Byte pad4_buffer[4];
...
extern volatile bit pad3_new_state;             /* apply_reset_values */
extern volatile bit pad4_new_state;             /* apply_reset_values */
...
extern volatile bit in3_busy;                 /* apply_reset_values */
extern volatile bit in4_busy;                 /* apply_reset_values */
